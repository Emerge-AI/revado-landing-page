...
const CTA = () => {
    ...
    return (
        <section id="contact" ref={sectionRef} className="py-20 bg-gradient-to-br from-blue-600 to-blue-800 text-white w-full">
                ...
                <div className={`max-w-4xl mx-auto bg-white/10 backdrop-blur-sm p-8 rounded-2xl shadow-xl transition-all duration-700 delay-300 transform ${isVisible ? 'translate-y-0 opacity-100 scale-100' : 'translate-y-10 opacity-0 scale-95'
                    ...
                    <div className="grid md:grid-cols-2 gap-8">
                        ...
                        <div className="flex flex-col h-full">
                            ...
                            <div className="mt-auto">
                                <button className="flex items-center bg-white/90 text-blue-600 px-6 py-3 rounded-lg hover:bg-white transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl text-lg font-medium group">
